...
def RAG(db_selected) :
    ...
    while True :
        ...
        if (question == "/q") or (question == "/exit") or (question == "/quit") :
            ...
            Instructions:
            1. Answer strictly based on the provided context. If the answer cannot be found in the context, state clearly that the context does not provide sufficient information.
            2. If the user's question asks for code (SQL queries, functions, scripts, etc.):
            - Provide the complete SQL code snippet.
